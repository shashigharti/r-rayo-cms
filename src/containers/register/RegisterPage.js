                            ...
                            <LoginDiv className="row">
                                <div
                                    ...
                                    <form name="form" onSubmit={this.handleSubmit}>
                                        ...
                                        <div
                                            className={'input-field' + (submitted && !user.first_name ? ' has-error' : '')}>
                                            <label htmlFor="firstName">First Name</label>
                                            <input type="text" className="form-control" name="first_name"
                                                   value={user.first_name} onChange={this.handleChange}/>
                                            {submitted && !user.first_name &&
                                            <div className="help-block red-text darken-3">First Name is required</div>
                                            }
                                        </div>
                                        <div
                                            className={'input-field' + (submitted && !user.last_name ? ' has-error' : '')}>
                                            <label htmlFor="lastName">Last Name</label>
                                            <input type="text" className="form-control" name="last_name"
                                                   value={user.last_name} onChange={this.handleChange}/>
                                        ...
                                        <div
                                            className={'input-field' + (submitted && !user.password ? ' has-error' : '')}>
                                        ...
                                        <div
                                            ...
                                            <input type="password" className="form-control" name="c_password"
                                                   value={user.c_password} onChange={this.handleChange}/>
